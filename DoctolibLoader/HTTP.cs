    ...
    public class htt
    {
        public static void Test()
        {
            ...
            try
            {
                ...
                // browse to GitHub
                browser.Navigate("https://signin.corona-impfung.nrw/adfs/oauth2/authorize?response_type=id_token%20token&response_mode=fragment&client_id=https%3A%2F%2FKvno.Impftermin.Portal&scope=openid&resource=https%3A%2F%2FKvno.Impftermin.Portal.WebApi&nonce=3226898987&pullStatus=1&redirect_uri=https%3A%2F%2Ftermin.corona-impfung.nrw%2Fhome");
                ...
                else
                {
                    ...
                    browser.Find("userNameInput").Value = "hakan_koese@outlook.de";
                    browser.Find("passwordInput").Value = "Saban6710";
                    browser.Find(ElementType.Button, "Anmelden", "commit").Click();
                    if (LastRequestFailed(browser)) return;
